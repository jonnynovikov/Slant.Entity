...
namespace Slant.Linq
{
    ...
    public abstract class ExpressionVisitor
    {
		...
		protected virtual MemberMemberBinding VisitMemberMemberBinding(MemberMemberBinding binding)
        {
            ...
            return HasVisited(bindings, binding.Bindings) ? Expression.MemberBind(binding.Member, bindings) : binding;
        }
        ...
        protected virtual MemberListBinding VisitMemberListBinding(MemberListBinding binding)
        {
            ...
            return HasVisited(initializers, binding.Initializers) ? Expression.ListBind(binding.Member, initializers) : binding;
        }
		...
		protected virtual NewExpression VisitNew(NewExpression nex)
        {
            ...
            return HasVisited(args, nex.Arguments)
                       ? (nex.Members != null
        ...
        protected virtual Expression VisitNewArray(NewArrayExpression na)
        {
            ...
            return HasVisited(exprs, na.Expressions)
	    ...
	    protected virtual Expression VisitInvocation(InvocationExpression iv)
        {
            ...
            return HasVisited(args, iv.Arguments) || expr != iv.Expression ? Expression.Invoke(expr, args) : iv;
        }

        [DebuggerNonUserCode]
        private static bool HasVisited(object original, object visited)
        {
            return !object.ReferenceEquals(original, visited);
        }
    }
}
